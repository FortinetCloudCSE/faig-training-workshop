---
title: "Use Case 7: Dashboard"
menuTitle: Use Case 7
weight: 370
---
...
1. Hover over the various pieces of information displayed within the charts to get more information about each area.
...
1. In the "Select..." box select "AI Flow".

1. In the next select box select "Is".

1. In the last select box select" "Intelligent Routing Example".

    ![Filter on Flows](<CleanShot 2026-07-28 at 14.31.32.png>)

1. Click on Apply.

1. The dashboard will update to show only the information from the selected AI Flow.
